...
function addArticles(urls){
    ...
    //Loop through all urls for this sections
    for(var x in urls){
        var request = $.ajax({  
...
function displayArticles(){
    ...
    for(var k = 0; k<articles.length; k++){
        ...
        //Add to feed the article link, title etc.
...
document.getElementById("teams").onchange = function() {
    ...
    $(".list").empty(); //Clear our feed
    addArticles(sites[this.value]); 
    var logo = this.value + '_logo'; //Change the logo for team/sport
